...
function Product({ product }) {
  ...
  return (
    <div>
      <div
        key={product._id}
        className={`product_wrapper d-flex bg-white border border-2 border-primary ${ProductItemStyle.product_wrapper}`}
      >
        ...
        >
          ...
          >
            <h1 className='mb-5 w-75'>{product.productName}</h1>
